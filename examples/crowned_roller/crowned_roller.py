...
used model keywords:
Heading, Boundary, RigidBody, Material, Elastic, SolidSection
...
def main():
    with ccx_model.Model(CCX_PATH, CGX_PATH, jobname='crowned_roller', working_dir=WKD) as model:
        ...
        model.add_model_keywords(mk.Heading('Crowned_roller_pressed_against_a_flat_plate')) # spaces are removed by cgx. At least under windows
