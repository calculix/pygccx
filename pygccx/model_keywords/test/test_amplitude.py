...
from pygccx.model_keywords import Amplitude
...
class TestAmplitude(TestCase):
    ...
    def test_shift_x(self):
        ...
        known = '*AMPLITUDE,NAME=TestAmp,SHIFTX=5.0000000e-01\n'
        known += '0.0000000e+00,0.0000000e+00\n'
        known += '1.0000000e-01,1.0000000e+00\n'
        known += '2.0000000e-01,-1.0000000e+00\n'
        known += '3.0000000e-01,3.0000000e+00\n'
    ...
    def test_shift_y(self):
        ...
        known = '*AMPLITUDE,NAME=TestAmp,SHIFTY=5.0000000e-01\n'
        known += '0.0000000e+00,0.0000000e+00\n'
        known += '1.0000000e-01,1.0000000e+00\n'
        known += '2.0000000e-01,-1.0000000e+00\n'
        known += '3.0000000e-01,3.0000000e+00\n'
    ...
    def test_total_time_shift_x_shift_y(self):
        ...
        known = '*AMPLITUDE,NAME=TestAmp,TIME=TOTAL TIME,SHIFTX=2.5000000e-01,SHIFTY=5.0000000e-01\n'
        known += '0.0000000e+00,0.0000000e+00\n'
        known += '1.0000000e-01,1.0000000e+00\n'
        known += '2.0000000e-01,-1.0000000e+00\n'
        known += '3.0000000e-01,3.0000000e+00\n'
