...
from pygccx.enums import ESetTypes, EElPrintResults, EPrintTotals
...
class ElPrint:
    ...
    Args:
        elset: Element set object for which results should be stored.
    ...
    elset:ISet
    """Element set object for which results should be stored."""
    entities:Iterable[EElPrintResults]
    ...
    def __str__(self):
        s = f'*EL PRINT,ELSET={self.elset.name}'
