...
class TestStatic(TestCase):
    ...
    def test_solver(self):
        ...
        self.assertRaises(ValueError, Static, solver=ESolvers.MATRIXSTORAGE)

        err = ''
        try: Static(solver=ESolvers.MATRIXSTORAGE)
        except ValueError as ve: err = str(ve)
        self.assertEqual(err, 'Solver MATRIXSTORAGE can not be used for a *STATIC step.')
